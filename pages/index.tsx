    ...
    return (
      <>
        <style jsx global>
          {`
      body {
          background: url('https://static.wixstatic.com/media/82da36_b204bba74b6240ee86585e8b49071a2b~mv2.png/v1/fill/w_750,h_357,al_c,q_85,usm_0.66_1.00_0.01,enc_auto/H%20-%202024-03-14T115740_537.png');
          background-size: cover;
  /* Center the background image */
  background-position: center;
  /* Optional: Specify a fallback color in case the image fails to load */
  background-color: #2d3748; /* Fallback color */
   ...
   `}
        ...
        <Modal isOpen={isShowNftOpen} onClose={onShowNftClose}>
          <ModalOverlay />
          <ModalContent>
            <ModalHeader>Your minted BabyPika:</ModalHeader>
            <ModalCloseButton />
            <ModalBody>
